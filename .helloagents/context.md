...
## 概述
CS60003 是“深度学习与空间智能”课程作业仓库，包含 HW1 与 HW2 的代码、数据配置、实验结果、模型发布说明和项目知识库。HW1 已完成 EuroSAT 三层 MLP；HW2 已包含 Task1 Flowers102 分类、Task2 Road Vehicle 检测/跟踪、Task3 Stanford Background 语义分割三条工程线。
