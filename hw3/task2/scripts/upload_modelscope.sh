...
$ENV_PY -m hw3_task2.upload_modelscope --model-dir "$MODEL_DIR" --repo-id "$REPO_ID" --output "$OUTPUT" --path-prefix "$PATH_PREFIX" --secret-env /data/yc/CS60003/.helloagents/secrets/hw3.env
