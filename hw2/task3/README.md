...
在 `hw2.md` 允许范围内继续优化后，当前最佳模型为 `task3_unet_ce_dice_b64_tta`：

- validation mIoU：`0.665089`
- validation pixel accuracy：`0.842011`
- best epoch：67
- SwanLab：<https://swanlab.cn/@youngchen/cs60003-hw2-task3/runs/9odmxzsyxzeo44c8joex7>
- ModelScope：`hw2/task3/unet_ce_dice_b64_tta/best.pt`
